...
api_key = 'b50ea41cc8256df325ea5e3ca2a1b496',
...
function getWeatherDetails(name, lat, lon, country, state) {
    // Note: forecast/daily is deprecated in free tier, so using 5-day/3hr forecast endpoint
    ...
    // 5-day forecast (filtering one per day)
    fetch(FORECAST_API_URL)
        ...
        .then(data => {
            ...
            fiveDaysForecastCard.innerHTML = ''; // Clear previous
